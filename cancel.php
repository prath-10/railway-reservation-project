...
<ul class="topmenu">
  ...
  <li><a class="active" href="http://localhost/railway/cancel.php" class="right">Cancellation</a></li>
...
<form action="http://localhost/railway/cancel.php" method="POST"><center><br><br>
