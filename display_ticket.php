...
<ul class="topmenu">
  ...
  <li><a class="active" href="http://localhost/railway/display_ticket.php">Booked Ticket Details</a></li>
...
<form action="http://localhost/railway/display_ticket.php" method="POST"><center><br><br>
