...
<center>
<ul class="topmenu">
  <li><a  href="http://localhost/railway/page1.php">Home</a></li>
  <li><a href="http://localhost/railway/cancel.php">Cancellation</a></li>
...
mysqli_select_db($conn,"railway-reservation");
...
?>
<br><br><form id="form3" action="http://localhost/railway/page3.php" method="POST">
